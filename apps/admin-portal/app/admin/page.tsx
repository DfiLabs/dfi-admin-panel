  ...
  const modules = [
    {
      ...
      url: 'https://admin.dfi-labs.com/factsheet/index.html',
      status: 'active'
    },
    {
      id: 'signal-dashboard',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {modules.map((module, index) => {
            ...
            return (
              ...
              >
                <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 h-full border border-gray-200 hover:border-indigo-300 hover:scale-105">
                  {/* Module Header */}
                  <div className="flex items-start justify-between mb-6">
                    <div className={`w-16 h-16 bg-gradient-to-r ${module.color} rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                  ...
                  {hoveredModule === module.id && module.status === 'active' && (
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      className="absolute inset-0 rounded-2xl ring-2 ring-indigo-300/80 pointer-events-none"
                    />
                  )}
                </div>
              </motion.div>
