...
Logs PV data to S3 using AWS CLI
...
S3_KEY = os.environ.get("S3_KEY", "signal-dashboard/data/portfolio_value_log.jsonl")
...
def lambda_handler(event, context):
    ...
    """
    print("🚀 Starting Lambda PV Logger...")

    try:
        # Run the main PV logging logic
        main()
